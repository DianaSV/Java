...
public class DataDrivenTestingBONUS {
    private static String ddtFile = "C:\\Automation\\TestAutomationBootCamp\\Selenium\\src\\test\\files\\data.csv";

    // ********** The call is from DataDriverTesting.java > test02_BONUS method **********
